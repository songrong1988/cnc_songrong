...
public class HandWheelFunction : MonoBehaviour {
	...
	{ 
		...
		if(!handWheelActive)
		{
			...
			if(deltAngle>=0)
				GUIUtility.RotateAroundPivot(currRotateAngle-angleOffset+rotatedAngle,handWheelOrigin);	
			else 
			{
				GUIUtility.RotateAroundPivot(360+deltAngle+rotatedAngle,handWheelOrigin);	
			}*/
